...
/**
 * Custom access denied handler that returns RFC 7807 Problem Detail responses.
 * Used when an authenticated user doesn't have permission to access a resource.
 */
@Component
