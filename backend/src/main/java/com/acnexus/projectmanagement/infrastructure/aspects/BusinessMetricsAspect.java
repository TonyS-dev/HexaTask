...
public class BusinessMetricsAspect {
     ...
     */
    @Pointcut("execution(* com.acnexus.projectmanagement.application.usecase.projects.CreateProjectUseCaseImpl.execute(..))")
     ...
     */
    @Pointcut("execution(* com.acnexus.projectmanagement.application.usecase.tasks.CreateTaskUseCaseImpl.execute(..))")
