package com.acnexus.projectmanagement.infrastructure.aspects;
...
public class PerformanceLoggingAspect {
     ...
     */
    @Pointcut("execution(* com.acnexus.projectmanagement.application.usecase..*.*(..))")
     ...
     */
    @Pointcut("execution(* com.acnexus.projectmanagement.infrastructure.web.controllers..*.*(..))")
     ...
     */
    @Pointcut("execution(* com.acnexus.projectmanagement.infrastructure.adapters.persistence..*.*(..))")
